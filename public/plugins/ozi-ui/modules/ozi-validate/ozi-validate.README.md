...
**Versão:** 2.2.0 · **Camada:** `modules/ozi-validate/`

Motor genérico de validação de campos, com *adapter pattern* para componentes de terceiros e
próprios. Inclui o gate de envio declarativo (`data-ozi-validate` no botão de submit).
