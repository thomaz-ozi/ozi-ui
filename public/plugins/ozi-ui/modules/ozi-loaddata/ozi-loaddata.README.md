...
**Versão:** 5.0.0 · **Camada:** `modules/ozi-loaddata/`

Transport central do OZI-UI — toda comunicação front → back passa por aqui, com feedback de UI
(busy, clear, destino de render).
