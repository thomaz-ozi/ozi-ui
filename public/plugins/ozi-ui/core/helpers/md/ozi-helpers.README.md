...
**Versão:** 1.1.0 · **Camada:** `core/helpers/`

Coleção de funções puras do OZI-UI: sem estado próprio, sem DOM persistente, sem dependência de
outros módulos. É quem emite os eventos do contrato v2 (`OZI.helpers.emit`).
