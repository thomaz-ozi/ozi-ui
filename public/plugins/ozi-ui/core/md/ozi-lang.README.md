...
Internacionalização (i18n). Toda string visível passa por `OZI.lang.t()` — nunca hardcoded no
plugin. Locales mantidos: `pt-BR`, `en`, `es`, com fallback embutido em cada plugin.
