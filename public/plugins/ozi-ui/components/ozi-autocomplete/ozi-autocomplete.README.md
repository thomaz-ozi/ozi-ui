...
**Versão:** 4.1.0 · **Camada:** `components/ozi-autocomplete/`

Input com sugestões filtradas — variante simplificada do `ozi-select`: single-select, sem grupos,
sem imagens. O usuário digita diretamente no input.
